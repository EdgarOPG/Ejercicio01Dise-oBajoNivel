 ...
 * @author edgar
 */
public class Arroz extends Platillos implements ICocinar{
    ...
    public void setEtipo(ETipo etipo) {
        super.setEtipo(etipo.ACOMPAÑAMIENTO); //To change body of generated methods, choose Tools | Templates.
    }
